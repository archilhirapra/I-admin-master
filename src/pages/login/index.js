    ...
    <Box className='content-center'>
        ...
        <CardContent sx={{p: theme => `${theme.spacing(13, 7, 6.5)} !important`}}>
          ...
          <form noValidate autoComplete='off' onSubmit={handleSubmit(onSubmit)}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <Link href='/login/mlogin' passHref>
      ...
      <Dialog open={open} aria-labelledby='form-dialog-title'>
          ...
          <CleaveWrapper>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                ...
                <Cleave autoFocus={true} disabled={cooldown > 0 ? ('') : ('disabled')} value={otpCodeInput}
                        onChange={otpChange} label="otp" className="form-field" id='blocks' placeholder='000 000'
        ...
        <DialogActions className='dialog-actions-dense roshan' sx={{justifyContent: 'space-between'}}>
          {/* <Button disabled={!timeup} onClick={handleResendCode}>Resend</Button> */}
