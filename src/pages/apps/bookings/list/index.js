...
// ** Custom Components Imports
import TableHeader from 'src/views/apps/bookings/list/TableHeader'
...
const UserList = () => {
  ...
  }, [dispatch, name, email, role, status, value, editUserOpen, addUserOpen])
  ...
  return (
    <Grid container spacing={6}>
            ...
            <Grid container spacing={6}>
              ...
              <Grid item sm={4} xs={12}>
                <FormControl fullWidth>
                  <InputLabel id='role-select'>Customer Type</InputLabel>
                  <Select
                    fullWidth
                    value={role}
                    id='customer_type'
                    ...
                    inputProps={{placeholder: 'Customer Type'}}
                  >
              ...
              <Grid item sm={4} xs={12}>
                <FormControl fullWidth>
                  <InputLabel id='status-select'>Paid Status</InputLabel>
                  <Select
                    fullWidth
                    value={status}
                    id='select-status'
                    ...
                    inputProps={{placeholder: 'Paid Status'}}
                  >
                    <MenuItem value=''>Paid Status</MenuItem>
      ...
      <AddUserDrawer open={addUserOpen} toggle={toggleAddUserDrawer} customerStore={customerStore}/>
