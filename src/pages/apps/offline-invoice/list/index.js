...
import {fetchOfflineInvoice} from 'src/store/apps/offline-invoice'
...
// ** Custom Components Imports
import TableHeader from 'src/views/apps/offline-invoice/list/TableHeader'


import AddUserDrawer from 'src/views/apps/offline-invoice/list/AddUserDrawer'
import EditAdminDrawer from 'src/views/apps/offline-invoice/list/EditUserDrawer'
...
const UserList = () => {
  ...
  // ** Hooks
  const dispatch = useDispatch()
  const store = useSelector(state => state.offlineInvoice)
  useEffect(() => {
    dispatch(
      fetchOfflineInvoice({
        status,
  ...
  }, [dispatch, name, role, status, value, minValue, maxValue, startDateRangetosend, endDateRangetosend, editUserOpen, addUserOpen])
