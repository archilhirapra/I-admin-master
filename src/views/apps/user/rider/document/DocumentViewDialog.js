      ...
      >
        ...
        <DialogContent sx={{ p: 6 }} dividers>
          <Grid container spacing={6}>
            ...
            >
              <Card sx={{ mb: 6, mr: 4 }}>
                <CardHeader title='Rider Details' titleTypographyProps={{ variant: 'h6' }} />
                <CardContent>
                  <Grid container spacing={6}>
              ...
              <Card sx={{ mb: 6, mr: 4 }}>
                <CardHeader title='Vehicle Details' titleTypographyProps={{ variant: 'h6' }} />
                <CardContent>
                  <Grid container spacing={6}>
                    <Grid item xs={12} lg={12}>
                      <TableContainer>
                        <Table size='small' sx={{ width: '95%' }}>
                          ...
                          >
                            <TableRow>
                              ...
                              <TableCell>
                                <Typography variant='body2'>{riderVehicleData?.registrationNo}</Typography>
                              </TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell>
                              ...
                              <TableCell>
                                <Typography variant='body2'>{riderVehicleData?.registrationDate}</Typography>
                              </TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell>
                              ...
                              <TableCell>
                                <Typography variant='body2'>{riderVehicleData?.chassisNo}</Typography>
                              </TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell>
                              ...
                              <TableCell>
                                <Typography variant='body2'>{riderVehicleData?.engineNo}</Typography>
                              </TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell>
                              ...
                              <TableCell>
                                <Typography variant='body2'>{riderVehicleData?.ownerName}</Typography>
                              </TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell>
                              ...
                              <TableCell>
                                <Typography variant='subtitle2'>{riderVehicleData?.vehicleClass}</Typography>
                              </TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell>
                              ...
                              <TableCell>
                                <Typography variant='subtitle2'>{riderVehicleData?.fuel}</Typography>
                              </TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell>
                              ...
                              <TableCell>
                                <Typography variant='subtitle2'>{riderVehicleData?.model}</Typography>
                              </TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell>
                              ...
                              <TableCell>
                                <Typography variant='subtitle2'>{riderVehicleData?.manufacturer}</Typography>
                              </TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell>
                              ...
                              <TableCell>
                                <Typography variant='subtitle2'>
                                  {riderVehicleData?.vehicleInsurance ? 'Yes' : 'No'}
                                </Typography>
                              </TableCell>
                            </TableRow>
                            <TableRow>
                              ...
                              <TableCell>
                                <Typography variant='subtitle2'>{riderVehicleData?.insuranceNumber}</Typography>
                              </TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell>
                              ...
                              <TableCell>
                                <Typography variant='subtitle2'>{riderVehicleData?.insuranceExpiry}</Typography>
                              </TableCell>
                            </TableRow>
                          </TableBody>
                        </Table>
