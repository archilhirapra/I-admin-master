...
import {editCategory} from 'src/store/apps/services/categories'
...
const SidebarAddUser = props => {
  ...
  useEffect(() => {
    ...
    setValue('subscription', editRow?.isSubscription)
  ...
  const continueEditing = () => {
    ...
    setLoading(false);
    const {name, description, status, subscription} = data
