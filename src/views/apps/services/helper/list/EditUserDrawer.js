...
import {editHelper} from 'src/store/apps/services/helpers'
...
const SidebarAddUser = props => {
  ...
  // ** Props
  const {open, toggle, editId, setEditId, editRow, setEditRow, categoryStore} = props
  ...
  useEffect(() => {
    setValue('question', editRow?.title)
    setValue('answer', editRow?.description)
  ...
  return (
    ...
    >
      <Header>
        <Typography variant='h6'>Edit Helper</Typography>
      ...
      <Box sx={{p: 5}}>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <FormControl fullWidth sx={{mb: 6}}>
            ...
            />
            {errors.answer && <FormHelperText sx={{color: 'error.main'}}>{errors.answer.message}</FormHelperText>}
          </FormControl>
